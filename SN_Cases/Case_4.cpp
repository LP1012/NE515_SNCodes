...
int main(int argc, char const *argv[])
{
    ...
    printf("***************************************************\n\n");
    double Sig_s = 0.99, L = 100, Sig_t = 1.0, Sig_f = 0.0; // given material data
    double tol = 1e-6;                                      // convergence tolerance
    double dz;                                              // allocate memory for later
    int n_cells[2] = {100,300};                                 // Define number of cells in space
    ...
    for (int I : n_cells)
    {
        ...
        output_filename = to_string(I) + "_case4_out.csv";
